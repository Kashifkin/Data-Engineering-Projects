...
This folder defines all source code for the 'Project_Pipeline' pipeline:
...
* Take a look at the sample under "sample_users_project_pipeline.py" to get familiar with the syntax.
